...
#include "CLCD_config.h" // to khow the type and mode
...
#if CLCD_Type == CLCd_4_16
	#define CLCD_ROW_3   3
	#define CLCD_ROW_4   4
	#define lcd_Line_3	                  0x90          // set cursor line 3
	#define lcd_Line_4	                  0xD0          // set cursor line 4
#elif CLCD_Type == CLCd_4_20
	#define CLCD_ROW_3   3
	#define CLCD_ROW_4   4
	#define lcd_Line_3	                  0x94          // set cursor line 3
	#define lcd_Line_4	                  0xD4          // set cursor line 4
...
#define lcd_Line_1	                  0x80          // set cursor line 1
#define lcd_Line_2	                  0xC0          // set cursor line 2
